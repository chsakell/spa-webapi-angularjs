...
namespace HomeCinema.Services.Utilities
{
    ...
    public partial class CommonHelper
    {
        ...
        public virtual bool IsCurrentConnectionSecured(HttpContext _httpContext)
        {
            bool useSsl = false;
            if (_httpContext != null)
            {
                ...
                {
                    useSsl = ServerVariables("HTTP_CLUSTER_HTTPS", _httpContext) == "on";
                }
                ...
                {
                    useSsl = string.Equals(ServerVariables("HTTP_X_FORWARDED_PROTO", _httpContext), "https", StringComparison.OrdinalIgnoreCase);
                }
                else
                {
        ...
        public virtual string ServerVariables(string name, HttpContext _httpContext)
        {
        ...
        public virtual string GetCurrentIpAddress(HttpContext _httpContext)
        {
